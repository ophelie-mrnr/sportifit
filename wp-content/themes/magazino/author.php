        ...
        <div id="main" class="clearfix" role="main">
            ...
            <div id="post-boxes-wrap" class="clearfix">
				...
				<header class="page-header">
					<h1 class="page-title author"><?php printf( __( 'Author Archives: %s', 'magazino' ), '<span class="colortxt vcard"><a class="url fn n" href="' . get_author_posts_url( get_the_author_meta( "ID" ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>' ); ?></h1>
